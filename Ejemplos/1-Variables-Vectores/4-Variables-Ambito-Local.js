...
{
    // Haremos que sea accesible en el hermano, pero no en el padre
    let variableLocal2;
    {
        ...
        var variableGlobal2 = 'Contenido variableGlobal2'; // Accesible desde cualquier lado (a partir de ahora)
        variableLocal2 = 'Contenido variableLocal2'; // Accesible solo en este bloque y bloques hijos
    ...
    {
        console.log('Nuevo bloque hermano', variableLocal2);
        console.log();
    }
}
